...
//        Log.e("Back My ---->", "Back1");
        ...
        recyclerView.setItemAnimator(new DefaultItemAnimator());
         UpcomingEvents = new String[]
                { "Assignment1", "Proposal Report", "Online Quiz", "Mid Exam" ,"Tutorial Test"};

         remainingDays = new String[]
                {"5 days remaining", "11 days remaining", "13 days more", "15 days more",  "27 days more" };
        ...
        recyclerView.setAdapter(new UpcomingEventAdapter(UpcomingEvents,remainingDays, Modules, getActivity()));
